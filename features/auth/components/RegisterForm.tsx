...
export default function RegisterForm() {
  ...
  const validate = (): Partial<RegisterFormState> => {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <TextField
        ...
        onChange={(e) =>
          setForm({ ...form, studentId: (e.target as HTMLInputElement).value })
        }
        leadingIcon="school"
      />
      ...
      <TextField
        ...
        onChange={(e) =>
          setForm({ ...form, residence: (e.target as HTMLInputElement).value })
        }
